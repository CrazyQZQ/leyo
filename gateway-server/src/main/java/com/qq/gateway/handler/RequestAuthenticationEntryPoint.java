...
public class RequestAuthenticationEntryPoint implements ServerAuthenticationEntryPoint {
    ...
    public Mono<Void> commence(ServerWebExchange serverWebExchange, AuthenticationException e) {
        ...
        DataBuffer buffer = response.bufferFactory().wrap(JSON.toJSONString(new AjaxResult(ExceptionCode.INVALID_TOKEN.getCode(), ExceptionCode.INVALID_TOKEN.getMsg())).getBytes(Charset.forName("utf-8")));
